...
function sharedKeysAndValidators (sharedKeys, validators, clientId, serverId, X, Y, Z, hK, V) {
  ...
  sodium.crypto_kdf_derive_from_key(sharedKeys.clientSk, 0, bint.fromString('PAKE2+EE'), k0)
  sodium.crypto_kdf_derive_from_key(sharedKeys.serverSk, 1, bint.fromString('PAKE2+EE'), k0)
  sodium.crypto_kdf_derive_from_key(validators.clientValidator, 2, bint.fromString('PAKE2+EE'), k0)
  sodium.crypto_kdf_derive_from_key(validators.serverValidator, 3, bint.fromString('PAKE2+EE'), k0)
